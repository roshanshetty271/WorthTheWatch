    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-surface px-4">
            <div className="w-full max-w-sm space-y-8">
                ...
                {/* Error message */}
                {error && (
                    <div className="rounded-lg bg-verdict-skip/10 border border-verdict-skip/20 p-3 text-sm text-verdict-skip text-center">
                ...
                <div className="text-center">
                    <a
                        href="/"
                        className="text-sm text-accent-gold hover:text-accent-goldLight transition-colors"
                    >
